...
const messages: Record<string, string> = {
  ...
  location_unavailable: "Địa điểm này chưa mở.",
  journey_in_progress: "Đang có một hành trình chưa xong.",
...
export const gameApi = {
  ...
  currentJourney: () => request<ExplorationResponse>("/exploration/journey"),
